      ...
      <nav className="sticky top-0 z-30 bg-zinc-950/75 backdrop-blur-xl border-b border-zinc-900/80 shadow-[0_4px_30px_rgba(0,0,0,0.4)]">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
          ...
          <Link to="/" onClick={() => setSearchQuery('')} className="flex items-center gap-3.5 group">
            <div className="w-11 h-11 bg-black border-2 border-mk-green-500/35 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(57,255,20,0.08)] group-hover:shadow-[0_0_25px_rgba(57,255,20,0.3)] group-hover:border-mk-green-400 transition-all duration-300">
          ...
          <div className="hidden md:flex flex-1 max-w-lg mx-12 relative animate-fade-in">
            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
              <Search className="h-4.5 w-4.5 text-zinc-500 group-focus-within:text-mk-green-400 transition-colors" />
            </div>
            <input 
              type="text" 
              value={searchQuery}
              ...
              className="w-full bg-zinc-900/60 border border-zinc-800/80 focus:border-mk-green-500/40 rounded-full pl-11 pr-10 py-2.5 text-sm text-white placeholder-zinc-500 outline-none transition-all focus:ring-4 focus:ring-mk-green-500/5 focus:bg-zinc-950/80"
            />
            {searchQuery && (
              <button 
          ...
          <div className="flex items-center gap-3">
            {!currentUser ? (
              <button 
                ...
                className="text-[11px] font-extrabold uppercase tracking-widest text-mk-green-400 hover:text-black px-6 py-2 bg-mk-green-950/30 hover:bg-mk-green-400 border border-mk-green-500/35 rounded-full transition-all duration-300 shadow-[0_0_15px_rgba(57,255,20,0.05)] active:scale-95"
              >
                Acessar Conta
              </button>
            ) : (
              <div className="relative">
                ...
                >
                  <div className="w-6 h-6 rounded-full bg-mk-green-400 text-black font-extrabold flex items-center justify-center text-xs shadow-[0_0_8px_rgba(57,255,20,0.3)]">
                ...
                {isMenuOpen && (
                  <div className="absolute top-full mt-3 right-0 w-64 bg-zinc-950 border border-zinc-800/95 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 z-50">
                    <div className="p-4 border-b border-zinc-900 bg-zinc-900/20">
                      ...
                      <p className="text-[10px] text-mk-green-400 font-mono uppercase tracking-wider mt-1">
                    ...
                    <div className="p-2 space-y-1">
                      {currentUser.isDeveloper ? (
                        ...
                        >
                          <MonitorDown size={15} className="text-mk-green-400" />
                          Publicar Aplicativo
                        </button>
                      ) : (
                        <button 
                          ...
                          className="w-full flex items-center gap-3 px-3.5 py-2.5 text-xs font-semibold text-zinc-300 hover:text-white hover:bg-zinc-900/90 rounded-xl transition-all"
                        >
                          <Code2 size={15} className="text-mk-green-400 animate-pulse" />
